    ...
    submit.onclick = function () {
        ...
        reader.onload = function (e) {
            let newmovie = {
                ...
                realisateur: document.getElementById("director")?.value,
...
function renderMovies() {
    ...
    if (movies.length === 0) {
        recipeMovies.innerHTML = "<p>No movies found.</p>";
        return;
    }
    ...
    selectedItem.classList.add("selected");
        ...
        <div class="details">
               ...
               <div>
                ...
                <p>year: ${selectedFilm.annee}</p>
                <p>director: ${selectedFilm.realisateur}</p>
...
function showUpdateForm(film) {
    ...
    detail.innerHTML = `
        ...
        <form id="updateForm">
            ...
            <input type="text" id="year" value="${film.annee}" required>
            
            <label for="deirector">director:</label>
            <input type="text" id="director" value="${film.realisateur}" required>
    ...
    updateForm.addEventListener("submit", function (e) {
        ...
        alert("the film has been updated successfully !");
       window.location.href = "index.html";
...
function deleteMovie(movieName) {
    ...
    if (updatedMovies.length < movies.length) {
        ...
        alert(`the film "${movieName}" has been deleted.`);
        window.location.href = "index.html";
    } else {
        alert(`the film "${movieName}" does not exist.`);
    }
}
